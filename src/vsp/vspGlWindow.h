...
//	enum { CURSOR_NONE, CURSOR_CROSSHAIR, CURSOR_TARGET };
	...
	int  mousePress( int x, int y, int sx, int sy );
	void mouseRelease( int x, int y, int sx, int sy );
	void mouseDrag( int x, int y, int sx, int sy );
	void mouseWheel( int x, int y, int sx, int sy );
	void mouseMove( int x, int y, int sx, int sy );
