...
DegenGeomTetraMassProp::DegenGeomTetraMassProp(int id, vec3d& p0, vec3d& p1, vec3d& p2, vec3d& p3)
{
	compId = id;
	...
	vol  = fabs(tetra_volume( v1, v2, v3 ));

	double Ix = vol/10.0*(v1.x()*v1.x() + v2.x()*v2.x() + v3.x()*v3.x() +
						   v1.x()*v2.x() + v1.x()*v3.x() + v2.x()*v3.x());

	double Iy = vol/10.0*(v1.y()*v1.y() + v2.y()*v2.y() + v3.y()*v3.y() +
						   v1.y()*v2.y() + v1.y()*v3.y() + v2.y()*v3.y());

	double Iz = vol/10.0*(v1.z()*v1.z() + v2.z()*v2.z() + v3.z()*v3.z() +
						   v1.z()*v2.z() + v1.z()*v3.z() + v2.z()*v3.z());
	...
	Ixy = vol/20.0*( 2.0*( v1.x()*v1.y() + v2.x()*v2.y() + v3.x()*v3.y() ) +
		  v1.x()*v2.y() + v2.x()*v1.y() + v1.x()*v3.y() + v3.x()*v1.y() + v2.x()*v3.y() + v3.x()*v2.y() );

	Iyz = vol/20.0*( 2.0*( v1.y()*v1.z() + v2.y()*v2.z() + v3.y()*v3.z() ) +
		  v1.y()*v2.z() + v2.y()*v1.z() + v1.y()*v3.z() + v3.y()*v1.z() + v2.y()*v3.z() + v3.y()*v2.z() );

	Ixz = vol/20.0*( 2.0*( v1.x()*v1.z() + v2.x()*v2.z() + v3.x()*v3.z() ) +
		  v1.x()*v2.z() + v2.x()*v1.z() + v1.x()*v3.z() + v3.x()*v1.z() + v2.x()*v3.z() + v3.x()*v2.z() );

}


DegenGeomTriShellMassProp::DegenGeomTriShellMassProp(int id, vec3d& p0, vec3d& p1, vec3d& p2)
{
	compId = id;
	...
	double Ix = tri_area/10.0*(v0.x()*v0.x() + v1.x()*v1.x() + v2.x()*v2.x() +
						       v0.x()*v1.x() + v0.x()*v2.x() + v1.x()*v2.x());

	double Iy = tri_area/10.0*(v0.y()*v0.y() + v1.y()*v1.y() + v2.y()*v2.y() +
						       v0.y()*v1.y() + v0.y()*v2.y() + v1.y()*v2.y());

	double Iz = tri_area/10.0*(v0.z()*v0.z() + v1.z()*v1.z() + v2.z()*v2.z() +
	...
	Ixy = tri_area/20.0*( 2.0*( v0.x()*v0.y() + v1.x()*v1.y() + v2.x()*v2.y() ) +
		  v0.x()*v1.y() + v1.x()*v0.y() + v0.x()*v2.y() + v2.x()*v0.y() + v1.x()*v2.y() + v2.x()*v1.y() );

	Iyz = tri_area/20.0*( 2.0*( v0.y()*v0.z() + v1.y()*v1.z() + v2.y()*v2.z() ) +
		  v0.y()*v1.z() + v1.y()*v0.z() + v0.y()*v2.z() + v2.y()*v0.z() + v1.y()*v2.z() + v2.y()*v1.z() );

	Ixz = tri_area/20.0*( 2.0*( v0.x()*v0.z() + v1.x()*v1.z() + v2.x()*v2.z() ) +
